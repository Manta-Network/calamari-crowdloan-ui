...
function Contribute({ fromAccount, accountBalance, totalFundsRaisedKSM}) {
    ...
    <div className="content-item p-8 xl:p-10 h-full contribute flex-1">
      ...
      <div className="flex items-center">
        <div className="form-input w-4/5 amount relative h-18">
          ...
          />
          <span onClick={onClickMax} className="uppercase cursor-pointer text-xl xl:text-3xl mt-2 right-0 mr-2 max-btn font-semibold absolute px-5 py-3 rounded-md">
            max
          </span>
        </div>
